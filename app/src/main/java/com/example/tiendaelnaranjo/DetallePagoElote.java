...
public class DetallePagoElote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pago_elote);
        ...
        tvProducto.setText("Seleccionaste "+cantidadProductos+" Elotes");
        ...
        tvDetalle.setText("Producto: Elote Enlatado" +
    ...
    public void PagarTotal(View view) {
        Intent intent = new Intent(this, DetallePagoElote.class);
