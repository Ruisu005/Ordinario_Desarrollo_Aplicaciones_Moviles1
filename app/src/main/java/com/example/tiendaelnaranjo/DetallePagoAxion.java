...
public class DetallePagoAxion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pago_axion);
        ...
        tvDetalle.setText("Producto: Detergente Axion" +
    ...
    public void PagarTotal(View view) {
        Intent intent = new Intent(this, DetallePagoAxion.class);
