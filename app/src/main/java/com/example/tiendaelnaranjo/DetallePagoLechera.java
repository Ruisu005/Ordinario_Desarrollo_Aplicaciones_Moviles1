...
public class DetallePagoLechera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pago_lechera);
        ...
        tvDetalle.setText("Producto: Leche La Lechera Semidescremada" +
    ...
    public void PagarTotal(View view) {
        Intent intent = new Intent(this, DetallePagoLechera.class);
