...
public class DetallePagoRajas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pago_rajas);
        ...
        tvProducto.setText("Seleccionaste "+cantidadProductos+" Chiles");
        ...
        tvDetalle.setText("Producto: jalapeños En Rajas Enlatado" +
    ...
    public void PagarTotal(View view) {
        Intent intent = new Intent(this, DetallePagoRajas.class);
    ...
    public void Regresar(View view){
        Intent regresar=new Intent(this, LateriaMenu.class);
