...
public class DetallePagoDeslactosada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pago_deslactosada);
        ...
        tvDetalle.setText("Producto: Leche LaLa Deslactosada" +
    ...
    public void PagarTotal(View view) {
        Intent intent = new Intent(this, DetallePagoDeslactosada.class);
