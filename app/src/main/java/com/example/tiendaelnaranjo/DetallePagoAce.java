...
public class DetallePagoAce extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pago_ace);
        ...
        tvDetalle.setText("Producto: Detergente Ace" +
    ...
    public void PagarTotal(View view) {
        Intent intent = new Intent(this, DetallePagoAce.class);
