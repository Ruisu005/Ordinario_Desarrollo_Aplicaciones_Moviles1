...
public class DetallePagoFrijol extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pago_frijol);
        ...
        tvProducto.setText("Seleccionaste "+cantidadProductos+" Frijoles");
        ...
        tvDetalle.setText("Producto: Frijol Enlatado" +
    ...
    public void PagarTotal(View view) {
        Intent intent = new Intent(this, DetallePagoFrijol.class);
