...
public class DetallePagoSalvo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_pago_salvo);
        ...
        tvDetalle.setText("Producto: Detergente Salvo" +
    ...
    public void PagarTotal(View view) {
        Intent intent = new Intent(this, DetallePagoSalvo.class);
